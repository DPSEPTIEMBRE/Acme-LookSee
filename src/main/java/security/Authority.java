...
public class Authority implements GrantedAuthority {
	...
	@NotBlank
	@Pattern(regexp = "^" + Authority.CANDIDATE + "|" + Authority.COMPANY + "|" 
						  + Authority.ADMINISTRATOR + "|" + Authority.VERIFIER + "$")
	@Override
	...
	public static Collection<Authority> listAuthorities() {
		...
		authority.setAuthority(Authority.CANDIDATE);
		...
		authority = new Authority();
		authority.setAuthority(Authority.VERIFIER);
		result.add(authority);

...
public class MailMessageController {
	...
	public ModelAndView saveCreate(@RequestParam String subject, @RequestParam String body,
			@RequestParam String priority, @RequestParam String mail) {
	...
	public ModelAndView moveTo(@RequestParam MailMessage q) {
		...
		result.addObject("mailmessage", q);
		result.addObject("folders", folderService.folderOfSelf());
		return result;
	}
